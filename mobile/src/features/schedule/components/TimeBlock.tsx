...
export function TimeBlock({ task, onPress, hasConflict }: TimeBlockProps) {
  ...
  // Calculate height based on duration (mock logic for demo: standard height)
  // Real implementation would calculate absolute pixel height relative to minutes.
  ...
  return (
    <View className="flex-row mb-4">
      ...
      <TouchableOpacity 
        onPress={onPress}
        className={cn(
          "flex-1 p-4 rounded-xl border-l-4",
          isActive 
